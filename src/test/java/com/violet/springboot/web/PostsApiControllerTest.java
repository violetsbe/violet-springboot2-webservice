...
public class PostsApiControllerTest {
    ...
    public void tearDown() throws Exception {
        postsReposirory.deleteAll();
    }

    @Test
    public void publish_posts() throws Exception {
        // given
        String title = "title";
        ...
        List<Posts> all = postsReposirory.findAll();
    ...
    public void update_posts() throws Exception {
        // given
        Posts savedPosts = postsReposirory.save(Posts.builder()
                .title("title")
                .content("content")
                .author("author")
                .build());
